    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        <Link to="/" className="text-2xl md:text-3xl font-bold font-karma text-primary">
          JS Graphics <span className="text-accent">& Design</span>
        </Link>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <button className="bg-primary text-off-white font-baloo py-2 px-6 rounded-full hover:bg-primary-dark transition-colors">
            Get Quote
          </button>
        </nav>
